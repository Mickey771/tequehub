...
const SectionThree = () => {
  return (
    <section className="flex justify-center px-6 xl:px-0 items-center flex-col w-full max-w-max mx-auto">
      <h2 className="text-center text-[#333333] text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold font-['Sora'] lg:leading-[64px]">
        Industries We Serve <br /> & Products We Build
      </h2>
